...
L.introduction = "Bienvenido a BigWigs, donde moran los jefes de banda. Abróchese el cinturón, póngase a comer cacahuetes y disfrute del paseo. Te ayudará a preparar de forma sencilla ese nuevo encuentro de banda como si fuese una cena de 7 platos para tu grupo de banda."
L.sound = "Sonido"
...
L.privateAuraSounds = "Sonidos de Auras Privadas"
L.privateAuraSounds_desc = "Las auras privadas no pueden ser registradas de forma normal, pero puedes reproducir un sonido cuando seas objetivo de la habilidad"
